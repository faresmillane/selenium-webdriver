...
config.htmlReport ? htmlReport = `--format html:cucumber-report-${process.env.DRIVER}.html ` : htmlReport = '';
config.jsonReport ? jsonReport = `--format json:cucumber-report-${process.env.DRIVER}.json ` : jsonReport = '';
