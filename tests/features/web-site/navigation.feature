...
# ajouter une préconnection pour ses deux scenarios
#  @SellPage
#  Scenario: navigate to sell page 
#    Given I navigate to "sell_page"
#    When I access in the "sell_page" screen
#    Then I see the "sell_page_header" label
#    And I see the "sell_page" label
