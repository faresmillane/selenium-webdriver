module.exports = {
    _body:[
        "SELECTOR=#fast-register-form-container > div > div.style_scrollable_container_icU.utils_p_16_1S5 > div > div",
        "CLASS=style_form_sub_container_X6o",
    ],
    _header:[
        "ID=fastregister__header",
        "SELECTOR=#fastregister__header",
        "XPATH=//*[@id='fastregister__header']"
    ],
    _inscription:[
