module.exports = {
    ...
    _suggest:[
        ...
        "XPATH=//div[@id='react-autowhatever-1']"
    ],
    _mega_ban:[
        "CLASS=hp--megaban--cta f14 pointer no-underline bg-transparent db tc"
    ],
    _vente:[
        "CLASS=navItemButton-module_label_ZAB helper_hide-BelowDesktop nowrap truncate"
    ]
}